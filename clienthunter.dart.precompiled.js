...
function dart_precompiled($collectedClasses) {
  ...
  function Bounty(score, docId, name) {
    this.score = score;
    this.docId = docId;
    this.name = name;
  }
  Bounty.builtin$cls = "Bounty";
  if (!"name" in Bounty)
    Bounty.name = "Bounty";
  $desc = $collectedClasses.Bounty;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Bounty.prototype = $desc;
  Bounty.prototype.get$score = function() {
    return this.score;
  };
  Bounty.prototype.get$name = function(receiver) {
    return this.name;
  };
  function Configuration(stopWords) {
  ...
  function Hunter(cargo, configuration, normalizer, _N) {
    this.cargo = cargo;
    this.configuration = configuration;
    this.normalizer = normalizer;
    this._N = _N;
  }
  Hunter.builtin$cls = "Hunter";
  if (!"name" in Hunter)
    Hunter.name = "Hunter";
  $desc = $collectedClasses.Hunter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hunter.prototype = $desc;
  function Hunter_feedDoc_closure(box_0) {
    this.box_0 = box_0;
  }
  Hunter_feedDoc_closure.builtin$cls = "Hunter_feedDoc_closure";
  if (!"name" in Hunter_feedDoc_closure)
    Hunter_feedDoc_closure.name = "Hunter_feedDoc_closure";
  $desc = $collectedClasses.Hunter_feedDoc_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hunter_feedDoc_closure.prototype = $desc;
  function Hunter_feedDoc_closure0(index_1) {
    this.index_1 = index_1;
  }
  Hunter_feedDoc_closure0.builtin$cls = "Hunter_feedDoc_closure0";
  if (!"name" in Hunter_feedDoc_closure0)
    Hunter_feedDoc_closure0.name = "Hunter_feedDoc_closure0";
  $desc = $collectedClasses.Hunter_feedDoc_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hunter_feedDoc_closure0.prototype = $desc;
  function Hunter_feedDoc_closure1(box_0, removals_2) {
    this.box_0 = box_0;
    this.removals_2 = removals_2;
  }
  Hunter_feedDoc_closure1.builtin$cls = "Hunter_feedDoc_closure1";
  if (!"name" in Hunter_feedDoc_closure1)
    Hunter_feedDoc_closure1.name = "Hunter_feedDoc_closure1";
  $desc = $collectedClasses.Hunter_feedDoc_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hunter_feedDoc_closure1.prototype = $desc;
  function Hunter_feedDoc_closure2(box_0) {
    this.box_0 = box_0;
  }
  Hunter_feedDoc_closure2.builtin$cls = "Hunter_feedDoc_closure2";
  if (!"name" in Hunter_feedDoc_closure2)
    Hunter_feedDoc_closure2.name = "Hunter_feedDoc_closure2";
  $desc = $collectedClasses.Hunter_feedDoc_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hunter_feedDoc_closure2.prototype = $desc;
  function Hunter_search_closure() {
  }
  Hunter_search_closure.builtin$cls = "Hunter_search_closure";
  if (!"name" in Hunter_search_closure)
    Hunter_search_closure.name = "Hunter_search_closure";
  $desc = $collectedClasses.Hunter_search_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Hunter_search_closure.prototype = $desc;
  function Normalizer() {
  }
  Normalizer.builtin$cls = "Normalizer";
  if (!"name" in Normalizer)
    Normalizer.name = "Normalizer";
  $desc = $collectedClasses.Normalizer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Normalizer.prototype = $desc;
  ...
  CargoBase.builtin$cls = "CargoBase";
  if (!"name" in CargoBase)
    CargoBase.name = "CargoBase";
  $desc = $collectedClasses.CargoBase;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CargoBase.prototype = $desc;
  ...
  function CargoDispatch() {
  }
  CargoDispatch.builtin$cls = "CargoDispatch";
  if (!"name" in CargoDispatch)
    CargoDispatch.name = "CargoDispatch";
  $desc = $collectedClasses.CargoDispatch;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CargoDispatch.prototype = $desc;
  function CargoModeHolder(_type) {
    this._type = _type;
  }
  CargoModeHolder.builtin$cls = "CargoModeHolder";
  if (!"name" in CargoModeHolder)
    CargoModeHolder.name = "CargoModeHolder";
  $desc = $collectedClasses.CargoModeHolder;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CargoModeHolder.prototype = $desc;
  function MemoryImpl() {
  }
  MemoryImpl.builtin$cls = "MemoryImpl";
  if (!"name" in MemoryImpl)
    MemoryImpl.name = "MemoryImpl";
  $desc = $collectedClasses.MemoryImpl;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MemoryImpl.prototype = $desc;
  function CargoBase_CargoDispatch() {
  }
  CargoBase_CargoDispatch.builtin$cls = "CargoBase_CargoDispatch";
  if (!"name" in CargoBase_CargoDispatch)
    CargoBase_CargoDispatch.name = "CargoBase_CargoDispatch";
  $desc = $collectedClasses.CargoBase_CargoDispatch;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CargoBase_CargoDispatch.prototype = $desc;
  function Cargo() {
  }
  Cargo.builtin$cls = "Cargo";
  if (!"name" in Cargo)
    Cargo.name = "Cargo";
  $desc = $collectedClasses.Cargo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Cargo.prototype = $desc;
  function CargoBase_CargoDispatch0() {
  }
  CargoBase_CargoDispatch0.builtin$cls = "CargoBase_CargoDispatch0";
  if (!"name" in CargoBase_CargoDispatch0)
    CargoBase_CargoDispatch0.name = "CargoBase_CargoDispatch0";
  $desc = $collectedClasses.CargoBase_CargoDispatch0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CargoBase_CargoDispatch0.prototype = $desc;
  function IndexDbCargo(dbName, storeName, _isOpen, count, cargo$CargoDispatch$mapping, _completer) {
    this.dbName = dbName;
    this.storeName = storeName;
    this._isOpen = _isOpen;
    this.count = count;
    this.cargo$CargoDispatch$mapping = cargo$CargoDispatch$mapping;
    this._completer = _completer;
  }
  IndexDbCargo.builtin$cls = "IndexDbCargo";
  if (!"name" in IndexDbCargo)
    IndexDbCargo.name = "IndexDbCargo";
  $desc = $collectedClasses.IndexDbCargo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexDbCargo.prototype = $desc;
  function IndexDbCargo_setItem_closure(this_0, key_1, data_2) {
    this.this_0 = this_0;
    this.key_1 = key_1;
    this.data_2 = data_2;
  }
  IndexDbCargo_setItem_closure.builtin$cls = "IndexDbCargo_setItem_closure";
  if (!"name" in IndexDbCargo_setItem_closure)
    IndexDbCargo_setItem_closure.name = "IndexDbCargo_setItem_closure";
  $desc = $collectedClasses.IndexDbCargo_setItem_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexDbCargo_setItem_closure.prototype = $desc;
  function IndexDbCargo__doCommand_closure(future_0) {
    this.future_0 = future_0;
  }
  IndexDbCargo__doCommand_closure.builtin$cls = "IndexDbCargo__doCommand_closure";
  if (!"name" in IndexDbCargo__doCommand_closure)
    IndexDbCargo__doCommand_closure.name = "IndexDbCargo__doCommand_closure";
  $desc = $collectedClasses.IndexDbCargo__doCommand_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexDbCargo__doCommand_closure.prototype = $desc;
  function IndexDbCargo_start_closure(this_0) {
    this.this_0 = this_0;
  }
  IndexDbCargo_start_closure.builtin$cls = "IndexDbCargo_start_closure";
  if (!"name" in IndexDbCargo_start_closure)
    IndexDbCargo_start_closure.name = "IndexDbCargo_start_closure";
  $desc = $collectedClasses.IndexDbCargo_start_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexDbCargo_start_closure.prototype = $desc;
  function IndexDbCargo_start__closure(this_1) {
    this.this_1 = this_1;
  }
  IndexDbCargo_start__closure.builtin$cls = "IndexDbCargo_start__closure";
  if (!"name" in IndexDbCargo_start__closure)
    IndexDbCargo_start__closure.name = "IndexDbCargo_start__closure";
  $desc = $collectedClasses.IndexDbCargo_start__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexDbCargo_start__closure.prototype = $desc;
  function IndexDbCargo_start_closure0(this_2) {
    this.this_2 = this_2;
  }
  IndexDbCargo_start_closure0.builtin$cls = "IndexDbCargo_start_closure0";
  if (!"name" in IndexDbCargo_start_closure0)
    IndexDbCargo_start_closure0.name = "IndexDbCargo_start_closure0";
  $desc = $collectedClasses.IndexDbCargo_start_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexDbCargo_start_closure0.prototype = $desc;
  function MemoryCargo(cargo$MemoryImpl$_completer, values, cargo$CargoDispatch$mapping, _completer) {
    this.cargo$MemoryImpl$_completer = cargo$MemoryImpl$_completer;
    this.values = values;
    this.cargo$CargoDispatch$mapping = cargo$CargoDispatch$mapping;
    this._completer = _completer;
  }
  MemoryCargo.builtin$cls = "MemoryCargo";
  if (!"name" in MemoryCargo)
    MemoryCargo.name = "MemoryCargo";
  $desc = $collectedClasses.MemoryCargo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MemoryCargo.prototype = $desc;
  function LocalstorageCargo(_cargo_client$_completer, values, cargo$CargoDispatch$mapping, _completer) {
    this._cargo_client$_completer = _cargo_client$_completer;
    this.values = values;
    this.cargo$CargoDispatch$mapping = cargo$CargoDispatch$mapping;
    this._completer = _completer;
  }
  LocalstorageCargo.builtin$cls = "LocalstorageCargo";
  if (!"name" in LocalstorageCargo)
    LocalstorageCargo.name = "LocalstorageCargo";
  $desc = $collectedClasses.LocalstorageCargo;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LocalstorageCargo.prototype = $desc;
